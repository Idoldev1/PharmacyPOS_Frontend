  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <form
        ...
        className="relative z-10 flex w-[430px] flex-col items-center justify-center overflow-y-auto bg-white px-8 py-10 shadow-2xl"
      >
        {/* H+ logo */}
        ...
        <p className="mb-7 mt-1 text-sm text-slate-500">Sign in to continue</p>

        {/* Role selector */}
        <div className="mb-5 w-full">
          <p className="mb-3 text-sm font-medium text-slate-700">Select Role</p>
        ...
        <div className="mb-4 w-full">
          <p className="mb-2 text-sm font-medium text-slate-700">Username</p>
          <input
            value={username}
        ...
        <div className="mb-5 w-full">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 pr-12 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-teal-500 focus:bg-white focus:ring-2 focus:ring-teal-100"
            />
            <button
              type="button"
        ...
        <button
          ...
          className="w-full rounded-xl bg-teal-600 py-3.5 text-sm font-semibold text-white transition-all hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
